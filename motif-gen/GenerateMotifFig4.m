...
% save data
try
    save('data/net/motif-fig-4/data_net_motif.mat','net');
catch
    mkdir('data/net/motif-fig-4');
    save('data/net/motif-fig-4/data_net_motif.mat','net');
end

try
    save('data/net/motif-fig-S2/data_net_motif.mat','net');
catch
    mkdir('data/net/motif-fig-S2');
    save('data/net/motif-fig-S2/data_net_motif.mat','net');
end
