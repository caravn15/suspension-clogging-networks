function GenerateMotifFig5NoBypass
...
% choose radii R
net.R = [1,1,1,1,0.9,0.6,0.6,0.9,1];
...
% save data
try
    save('data/net/motif-fig-5-no-bypass/data_net_motif.mat','net');
catch
    mkdir('data/net/motif-fig-5-no-bypass');
    save('data/net/motif-fig-5-no-bypass/data_net_motif.mat','net');
end
