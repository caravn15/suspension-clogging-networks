function GenerateMotifFigS5NoBypass
...
% choose radii R
net.R = [1,1,1,1,0.8,0.5,0.5,0.8,1];

% choose lengths L
net.L = [1,1,0.5,0.5,1,0.5,0.5,1,1];
...
net.EdgePointIndices{4}  = [3,4]';
net.EdgePointIndices{5}  = [4,8,9]';
net.EdgePointIndices{6}  = [6,7]';
...
net.IsInlet(1)           = 1;
net.NumEdgePoints        = [1,3,3,2,3,2,1,1,1,1]';
...
% save data
try
    save('data/net/motif-fig-S5-no-bypass/data_net_motif.mat','net');
catch
    mkdir('data/net/motif-fig-S5-no-bypass');
    save('data/net/motif-fig-S5-no-bypass/data_net_motif.mat','net');
end
