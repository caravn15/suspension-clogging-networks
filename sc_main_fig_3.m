%% RUNS SIMULATIONS FOR AND PLOTS FIG. 3 OF THE MAIN MANUSCRIPT
% USES THE SAME DATA AS FIG. S1 OF THE SUPPLEMENTARY MATERIAL -
% YOU ONLY NEED TO RUN ONE SET OF SIMULATIONS (THIS SCRIPT OR
% sc_supp_mat_fig_S1.m)
...
nexttile; PlotFig3LinesPhi(1,sol,R24_v,1,1,[0.6,0.72],[0.6,0.66,0.72])
nexttile; PlotFig3LinesPhi(2,sol,R24_v,1,1,[0.6,0.68],[0.6,0.64,0.68])
nexttile; PlotFig3LinesPhi(3,sol,R24_v,1,1,[0.4,0.7],[0.4,0.55,0.7])
