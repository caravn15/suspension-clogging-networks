%% RUNS SIMULATIONS FOR AND PLOTS FIG. 5 OF THE MAIN MANUSCRIPT
...
phin          = 0.6;                      % inlet particle volume fraction (must be < phim)
...
DataLoad      = {};
% DataLoad      = {'fig_5_Da_0.001_phin_0.6_phm_0.85'};

% For DataLoad, set as empty {} to run solve + plot, or provide path to sim. data in fld to skip solve
% Data format: cell e.g. {'fig_5_Da_0.001_phin_0.6_phm_0.85'}
...
if PlotMotifs == 1
    ...
    R48_v  = [0.1,0.7,0.1,0.7];
    R910_v = [0.8,0.8,0.55,0.55];
